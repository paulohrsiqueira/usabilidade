...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main.Home = class Home extends framework.StatelessWidget {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({leading: C[1] || CT.C1, title: C[3] || CT.C3}), body: new basic.Center.new({child: new container.Container.new({width: 500, height: 500, decoration: new box_decoration.BoxDecoration.new({shape: box_border.BoxShape.circle, color: colors.Colors.yellow}), child: new basic.Center.new({child: new image.Image.asset("assets/img/paisagem.jpeg", {width: 300, height: 300})})})}), floatingActionButton: new floating_action_button.FloatingActionButton.new({onPressed: dart.fn(() => {
